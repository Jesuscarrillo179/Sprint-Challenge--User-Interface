...
semantic html gives content meaning by applying tags where they most deemed fit.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
inline stays within the content, block takes up the whole space.

3. What are the 4 areas of the box model?
content,padding,border,margin

4. While using flexbox, what axis does the following property work on: ```align-items: center```?
centers the height or Y-axis.

5. Explain why git is valuable to a team of developers.
a team can branch of from the main project, work on their sections, and each person can merge their files into one main copy.
